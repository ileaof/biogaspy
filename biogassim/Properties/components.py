...
_COMPONENTS: dict[str, Component] = {
    ...
    "H2": Component(
        name="Hydrogen", formula="H2", MM=0.0020159,
        Tc=33.19, Pc=1.313e6, omega=-0.216, Tb=20.27,
        cp_ideal=ShomateCp(33.066178, -11.363417, 11.432816, -2.772874, -0.158558,
                           298.0, 1000.0),
        comment="NIST Shomate (298-1000 K). ω negativo (efeitos quânticos).",
    ),
    "CO": Component(
        name="CarbonMonoxide", formula="CO", MM=0.028010,
        Tc=132.85, Pc=3.494e6, omega=0.045, Tb=81.65,
        cp_ideal=ShomateCp(25.56759, 6.096130, 4.054656, -2.671301, 0.131021,
                           298.0, 1300.0),
        comment="NIST Shomate. Tc/Pc de DIPPR.",
    ),
    "NH3": Component(
        name="Ammonia", formula="NH3", MM=0.017031,
        Tc=405.40, Pc=11.28e6, omega=0.257, Tb=239.82,
        cp_ideal=ShomateCp(19.99563, 49.77119, -15.37599, 1.921168, 0.189174,
                           298.0, 1400.0),
        Hvap=23330.0,
        comment="NIST Shomate (298-1400 K). Tc/Pc de DIPPR.",
    ),
    "Ar": Component(
        name="Argon", formula="Ar", MM=0.039948,
        Tc=150.687, Pc=4.863e6, omega=-0.002, Tb=87.30,
        cp_ideal=ShomateCp(20.786, 0.0, 0.0, 0.0, 0.0, 298.0, 6000.0),
        comment="Monoatômico: Cp = 5/2 R ≈ 20.786 J/mol·K (constante).",
    ),
    "MEA": Component(
